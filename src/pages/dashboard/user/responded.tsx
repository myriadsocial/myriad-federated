...
const UserResponded: NextPageWithLayout = () => {
  ...
  const {
    ...
    ['/getAllUserResponded', pageNumber],
...
UserResponded.getLayout = function getLayout(page: ReactElement) {
  return <ContentLayout title="User">{page}</ContentLayout>;
};

export default UserResponded;
